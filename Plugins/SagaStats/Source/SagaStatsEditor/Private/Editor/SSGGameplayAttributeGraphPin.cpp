...
****************************************************************************************************************/
#include "Editor/SSGGameplayAttributeGraphPin.h"
...
void SSGGameplayAttributeGraphPin::Construct( const FArguments& InArgs, UEdGraphPin* InGraphPinObj )
{
...
TSharedRef<SWidget>	SSGGameplayAttributeGraphPin::GetDefaultValueWidget()
{
	...
	return SNew(SVerticalBox)
		...
		.AutoHeight()
		[
			SNew(SSGGameplayAttributeWidget)
			.OnAttributeChanged(this, &SSGGameplayAttributeGraphPin::OnAttributeChanged)
			...
			.IsEnabled(this, &SSGGameplayAttributeGraphPin::GetDefaultValueIsEnabled)

		];
}

//Feature Begin Attribute In subclass of AttributeSet
void SSGGameplayAttributeGraphPin::OnAttributeChanged(FProperty* SelectedAttribute, UClass* InAttributeOwnerClass)
{
	FString FinalValue;
