...
USSK2Node_SwitchGameplayAttribute::USSK2Node_SwitchGameplayAttribute(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	FunctionName = TEXT("NotEqual_GameplayAttributeGameplayAttribute");
	FunctionClass = USSBlueprintLibrary::StaticClass();
	OrphanedPinSaveMode = ESaveOrphanPinMode::SaveNone;
}

void USSK2Node_SwitchGameplayAttribute::CreateFunctionPin()
{
...
void USSK2Node_SwitchGameplayAttribute::PostLoad()
{
	Super::PostLoad();
...
void USSK2Node_SwitchGameplayAttribute::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	bool bIsDirty = false;
	const FName PropertyName = PropertyChangedEvent.Property ? PropertyChangedEvent.Property->GetFName() : NAME_None;
	if (PropertyName == GET_MEMBER_NAME_CHECKED(USSK2Node_SwitchGameplayAttribute, PinAttributes) || PropertyName == FName("AttributeName"))
	{
		bIsDirty = true;
	}
...
FText USSK2Node_SwitchGameplayAttribute::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "ASBP_Switch_GameplayAttribute", "Switch on Gameplay Attribute");
}

FText USSK2Node_SwitchGameplayAttribute::GetTooltipText() const
{
...
void USSK2Node_SwitchGameplayAttribute::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void USSK2Node_SwitchGameplayAttribute::CreateSelectionPin()
{
...
FEdGraphPinType USSK2Node_SwitchGameplayAttribute::GetPinType() const
{
...
FEdGraphPinType USSK2Node_SwitchGameplayAttribute::GetInnerCaseType() const
{
	// This type should match the second argument of USSBlueprintLibrary::NotEqual_GameplayAttributeGameplayAttribute !
	FEdGraphPinType PinType;
	PinType.PinCategory = UEdGraphSchema_K2::PC_String;
	return PinType;
}

FName USSK2Node_SwitchGameplayAttribute::GetPinNameGivenIndex(const int32 Index) const
{
	check(Index);
	return PinNames[Index];
}

void USSK2Node_SwitchGameplayAttribute::CreateCasePins()
{
...
FName USSK2Node_SwitchGameplayAttribute::GetUniquePinName()
{
	FName NewPinName;
	int32 Index = 0;
	while (true)
...
void USSK2Node_SwitchGameplayAttribute::AddPinToSwitchNode()
{
	const FName PinName = GetUniquePinName();
	PinNames.Add(PinName);
...
void USSK2Node_SwitchGameplayAttribute::RemovePin(UEdGraphPin* TargetPin)
{
	checkSlow(TargetPin);
...
bool USSK2Node_SwitchGameplayAttribute::IsGasCompanionPluginEnabled()
{
