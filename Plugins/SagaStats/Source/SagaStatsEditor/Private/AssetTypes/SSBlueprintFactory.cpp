...
private:
	...
	void MakeParentClassPicker()
	{
		...
		Filter->AllowedChildrenOfClasses.Add(USSAttributeSetBlueprintBase::StaticClass());
...
UObject* USSBlueprintFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn, FName CallingContext)
{
	...
	if ((ParentClass == nullptr) || !FKismetEditorUtilities::CanCreateBlueprintOfClass(ParentClass) || !ParentClass->IsChildOf(USSAttributeSetBlueprintBase::StaticClass()))
	{
	...
	{
		USSAttributeSetBlueprint* NewBP = CastChecked<USSAttributeSetBlueprint>(FKismetEditorUtilities::CreateBlueprint(ParentClass, InParent, Name, BlueprintType, USSAttributeSetBlueprint::StaticClass(), UBlueprintGeneratedClass::StaticClass(), CallingContext));
		...
		if (NewBP)
		{
			...
			if (Settings && Settings->bSpawnDefaultBlueprintNodes)
			{
				...
				FKismetEditorUtilities::AddDefaultEventNode(NewBP, EventGraph, FName(TEXT("K2_PostGameplayEffectExecute")), USSAttributeSetBlueprintBase::StaticClass(), NodePositionY);
				FKismetEditorUtilities::AddDefaultEventNode(NewBP, EventGraph, FName(TEXT("K2_PostAttributeChange")), USSAttributeSetBlueprintBase::StaticClass(), NodePositionY);
