...
class IGBAGameplayAttributeDataDetailsBase;
...
{
public:
	explicit FGBAGameplayAttributeDataDetailsRow(const TWeakPtr<IGBAGameplayAttributeDataDetailsBase>& InDetailsOwner, const FText& InRowNameText, float InInitialValue);
	virtual ~FGBAGameplayAttributeDataDetailsRow() = default;
