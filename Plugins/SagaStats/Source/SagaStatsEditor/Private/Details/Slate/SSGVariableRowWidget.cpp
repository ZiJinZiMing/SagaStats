...
****************************************************************************************************************/
#include "SSGVariableRowWidget.h"
...
// void SSGVariableRowWidget::Construct(const FArguments& InArgs, const TSharedPtr<SWidget>& InNameContent, const TSharedPtr<SWidget>& InValueContent)
void SSGVariableRowWidget::Construct(const FArguments& InArgs)
{
