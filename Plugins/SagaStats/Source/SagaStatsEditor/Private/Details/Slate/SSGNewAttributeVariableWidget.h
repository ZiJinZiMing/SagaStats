 ...
 */
class SSGNewAttributeVariableWidget : public SCompoundWidget
{
public:

	DECLARE_DELEGATE_OneParam(FOnWindowClosed, const TSharedPtr<FSGNewAttributeViewModel>&);
	
	SLATE_BEGIN_ARGS(SSGNewAttributeVariableWidget) {}
	...
	void Construct(const FArguments& InArgs, const TSharedPtr<FSGNewAttributeViewModel>& InViewModel);
...
private:
	...
	TSharedPtr<FSGNewAttributeViewModel> ViewModel;
