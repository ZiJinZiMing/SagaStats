...
void SSSGameplayAttributeListWidget::Construct(const FArguments& InArgs)
{
	...
	// ISSEditorModule::Get().PreloadAssetsByClass(USSAttributeSetBlueprint::StaticClass());
	FSagaStatsEditorModule::Get().PreloadAssetsByClass(USSAttributeSetBlueprint::StaticClass());
