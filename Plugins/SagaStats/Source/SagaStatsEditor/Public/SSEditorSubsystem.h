...
#include "SSEditorSubsystem.generated.h"
 ...
 * ---
 *
 * Subsystem register to an OnVariableRename delegate fired off from `USSAttributeSetBlueprint`, and handle any editor specific code.
 *
 ...
 */
UCLASS()
class SAGASTATSEDITOR_API USSEditorSubsystem : public UEditorSubsystem
{
	GENERATED_BODY()
