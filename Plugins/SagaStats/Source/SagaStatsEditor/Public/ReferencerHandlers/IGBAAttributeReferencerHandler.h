...
struct SAGASTATSEDITOR_API FGBAAttributeReferencerPayload
{
 ...
 */
class SAGASTATSEDITOR_API IGBAAttributeReferencerHandler : public TSharedFromThis<IGBAAttributeReferencerHandler>
{
public:
