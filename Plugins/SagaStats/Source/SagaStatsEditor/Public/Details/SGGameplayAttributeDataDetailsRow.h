...
class ISGGameplayAttributeDataDetailsBase;
 ...
 */
class FSGGameplayAttributeDataDetailsRow : public TSharedFromThis<FSGGameplayAttributeDataDetailsRow>
{
public:
	explicit FSGGameplayAttributeDataDetailsRow(const TWeakPtr<ISGGameplayAttributeDataDetailsBase>& InDetailsOwner, const FText& InRowNameText, float InInitialValue);
	virtual ~FSGGameplayAttributeDataDetailsRow() = default;
...
private:
	...
	TWeakPtr<ISGGameplayAttributeDataDetailsBase> DetailsOwnerPtr;
	FText RowNameText;
