// DamageContext.cpp — v4.8: 双存储（ContextFacts + DamageEffects）
...
// ============================================================================
// DamageRule Effect 存储（v4.8: UScriptStruct* key）
// ============================================================================

void UDamageContext::SetEffectByType(UScriptStruct* EffectType, const FInstancedStruct& Value)
{
	if (EffectType) DamageEffects.Add(EffectType, Value);
}
