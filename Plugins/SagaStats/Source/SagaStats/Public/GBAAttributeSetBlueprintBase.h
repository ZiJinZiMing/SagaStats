...
struct SAGASTATS_API FGBAAttributeSetExecutionData
{
	GENERATED_BODY()
...
USTRUCT()
struct SAGASTATS_API FGBAClampDefinition
{
	GENERATED_BODY()
...
struct SAGASTATS_API FGBAGameplayClampedAttributeData : public FGameplayAttributeData
{
	GENERATED_BODY()
...
class SAGASTATS_API UGBAAttributeSetBlueprintBase : public UAttributeSet
{
	GENERATED_BODY()
