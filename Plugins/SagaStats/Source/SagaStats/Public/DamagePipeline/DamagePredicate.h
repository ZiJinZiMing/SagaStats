...
// DamagePredicate.h — 谓词容器（无 ResolveProducer，依赖通过 EffectType 直接解析）
#pragma once
...
public:
	...
	virtual bool Evaluate(const UDamageContext* Context) const PURE_VIRTUAL(UDamagePredicate::Evaluate, return false;);
