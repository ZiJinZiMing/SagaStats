...
class SAGASTATS_API USSAttributeSetBlueprintBase : public UAttributeSet
{
	GENERATED_BODY()

public:
	explicit USSAttributeSetBlueprintBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
