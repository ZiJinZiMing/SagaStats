...
class UAbilitySystemComponent : public UGameplayTasksComponent, public IGameplayTagAssetInterface, public IAbilitySystemReplicationProxyInterface
{
	...
	//ZhangJinming - Begin Change - Attribute In subclass of AttributeSet
	
	/** Add a new attribute set */
	//UE_API void AddSpawnedAttribute(UAttributeSet* Attribute);
	UE_API virtual  void AddSpawnedAttribute(UAttributeSet* Attribute);

	/** Remove an existing attribute set */
	//UE_API  void RemoveSpawnedAttribute(UAttributeSet* Attribute);
	UE_API virtual void RemoveSpawnedAttribute(UAttributeSet* Attribute);

	/** Remove all attribute sets */
	//UE_API void RemoveAllSpawnedAttributes();
	UE_API virtual void RemoveAllSpawnedAttributes();

	//ZhangJinming - End Change
	...
	*/
	...
	FGameplayAbilityTargetDataHandle InternalTryActivateAbilityFailureTargetData;
...
protected:
	...
	UE_API virtual void PostClientActivateAbilityFailed(FGameplayAbilitySpecHandle AbilityToActivate, int16 PredictionKey){}
	//Han Jiping - End Change
...
protected:
	...
	UE_API virtual void OnRep_SpawnedAttributes(const TArray<UAttributeSet*>& PreviousSpawnedAttributes);
private:
	//ZhangJinming - End Change
