...
public:
	...
	UE_API virtual bool ShouldAbilityRespondToEvent(const FGameplayAbilityActorInfo* ActorInfo, const FGameplayEventData* Payload, FGameplayAbilityTargetDataHandle* TryActivateAbilityFailureTargetData = nullptr) const;
