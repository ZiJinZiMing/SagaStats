...
bool UGameplayAbility::ShouldAbilityRespondToEvent(const FGameplayAbilityActorInfo* ActorInfo, const FGameplayEventData* Payload, FGameplayAbilityTargetDataHandle* TryActivateAbilityFailureTargetData) const
